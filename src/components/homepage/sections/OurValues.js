        ...
        <div className="openSourceTogetherWrapper">
          <div className="titleDescriptionWrapper">
            ...
            <div className="description">
              <p>
                We are on a mission to shape the best tools and dialogue about
                the business of open source sustainability. Our members range
                from for-profit technology companies to non-profits’ voices.
                Come join us.
              </p>
            </div>
          ...
          <div className="partners">
            ...
            <div className="partner">
              <a href="https://maintainer.io">
                <img
                  src="/static/img/homepage/last-partner.svg"
                  alt="Partner"
                />
              </a>
            </div>
