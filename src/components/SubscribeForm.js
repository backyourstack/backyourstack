      ...
      <Fragment>
        ...
        {!subscribed &&
          <form method="POST" action="" onSubmit={this.handleSubmit}>
            <input type="email" placeholder="Enter your email" onChange={this.handleChange} value={email} />
            <input type="submit" value="Subscribe" className="button bigButton" />
          </form>
        }
        {subscribed &&
          <p><strong>Successfully subscribed!</strong></p>
        }
